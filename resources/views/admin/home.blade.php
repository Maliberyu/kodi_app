                ...
                <div class="p-10">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-16 animate-fade-in-delay-5">
                        ...
                        <a href="#" 
                            ...
                            <h3 class="text-2xl font-bold text-gray-700">Input E-Module</h3>
                        ...
                        <a href="#" 
                            ...
                            <h3 class="text-2xl font-bold text-gray-700">Kelola Koin</h3>
                            <p class="text-gray-500 mt-2">Atur dan distribusikan koin</p>
                        </a>
